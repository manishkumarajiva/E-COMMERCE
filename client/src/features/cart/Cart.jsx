          ...
          <div className='flow-root'>
            ...
            <ul className='-my-6 divide-y divide-gray-200'>
              {cartItems.map((product) => (
                <li key={product.id} className='flex md:flex-col lg:flex-col xl:flex-row  py-6'>
                  ...
                  <div className='ml-4 flex flex-1 flex-col'>
                    <div>
                      <div className='lg:mx-auto flex justify-between text-base font-medium text-gray-900'>
                        <h3>
                          ...
                          <div className="text-sm text-slate-600" href={product.href}>{product.brand}</div>
                        </h3>
                    ...
                    <div className='flex flex-1 items-end justify-between text-sm'>
                      <div className='flex'>
                        ...
                        <select onChange={(e)=>updateHandler(e, product)} value={product.quantity} className='h-6 w-10 p-0 border-0 ms-2' id='qty'>
